...
export default function App() {
  ...
  const movie=[{pic:"https://englishtribuneimages.blob.core.windows.net/gallary-content/2021/6/Desk/2021_6$largeimg_977224513.JPG",
                title:"RRR",
                rating:"⭐ 8.8",
  ...
  return (
    ...
    {movie.map((movie_details)=>
      <Message pic={movie_details.pic} title={movie_details.title} rating={movie_details.Rating} content={movie_details.content}/>)}
    </div>
  );
}
function Message(props){
  ...
  <div className='moviedetails'>
    <span>
    <img className='poster' src={props.pic} alt={props.title}/>
<h4 className='title'>{props.title}</h4>
<p className='rating'>{props.rating}</p></span>
